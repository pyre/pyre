...
pyre::journal::py::help(py::module & m)
{
    ...
    py::class_<help_t>(m, "Help")
        ...
        .def(
            // the implementation
            py::init<const help_t::name_type &, detail_t, dent_t>(),
            // the signature
            "name"_a,
            "detail"_a = 1,
            "dent"_a = 0)
        ...
        .def_property(
            "detail",
            // the getter
            py::overload_cast<>(&help_t::detail, py::const_),
            // the setter
            py::overload_cast<help_t::detail_type>(&help_t::detail),
            // the docstring
            "the detail level")
        ...
        .def_property(
            "dent",
            // the getter
            py::overload_cast<>(&help_t::dent, py::const_),
            // the setter
            py::overload_cast<help_t::dent_type>(&help_t::dent),
            // the docstring
            "the dent level")
        ...
        .def_property(
            "active",
            // the getter
            py::overload_cast<>(&help_t::active, py::const_),
            // the setter
            py::overload_cast<help_t::active_type>(&help_t::active),
            // the docstring
        ...
        .def_property(
            "fatal",
            // the getter
            py::overload_cast<>(&help_t::fatal, py::const_),
            // the setter
            py::overload_cast<help_t::fatal_type>(&help_t::fatal),
            // the docstring
            "the channel activation state")
        ...
        .def(
            "log",
            // the handler
            [](help_t & channel, const help_t::string_type & message,
               // additional arguments are interpreted as entry notes
               py::kwargs kwds) -> help_t & {
                // unpack {kwds}
                for (auto entry : kwds) {
