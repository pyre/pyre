...
pyre::journal::py::info(py::module & m)
{
    ...
    py::class_<info_t>(m, "Informational")
        ...
        .def_property_readonly(
            ...
            [](info_t & channel) -> pyre::journal::page_t & { return channel.entry().page(); },
            // the docstring
        ...
        .def_property_readonly(
            ...
            [](info_t & channel) -> pyre::journal::notes_t & { return channel.entry().notes(); },
            // the docstring
        ...
        .def_property_readonly_static(
            "severity",
            // the getter
            [](py::object) -> info_t::string_type { return "info"; },
            // the docstring
        ...
        .def_property_readonly_static(
            "defaultActive",
            // the getter
            [](py::object) -> info_t::active_type { return info_t::index().active(); },
            // the docstring
        ...
        .def_property_readonly_static(
            "defaultFatal",
            // the getter
            [](py::object) -> info_t::fatal_type { return info_t::index().fatal(); },
            // the docstring
        ...
        .def_property_static(
            "defaultDevice",
            // the getter
            [](py::object) -> info_t::device_type { return info_t::index().device(); },
            // the setter
            [](py::object, info_t::device_type device) { info_t::index().device(device); },
            // the docstring
        ...
        .def(
            "line",
            // the handler
            [](info_t & channel, py::object msg) {
                // cast to string
                info_t::string_type message = py::str(msg);
                // inject
        ...
        .def_static(
            "logfile",
            // the implementation
            [](const info_t::string_type & path) { info_t::logfile(path); },
            // the docstring
