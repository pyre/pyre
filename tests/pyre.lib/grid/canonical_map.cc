...
main(int argc, char * argv[])
{
    ...
    channel
        ...
        << "cells: " << packing.cells() << pyre::journal::newline << "nudge: " << packing.nudge()
        << pyre::journal::newline << "begin: " << *packing.begin() << pyre::journal::newline
        << "end: " << *packing.end() << pyre::journal::newline << "index: " << index
        << pyre::journal::newline << "offset: " << offset << pyre::journal::newline
