...
// given a file named "constdirect-grid.dat" in the current directory, use the high level
// interface to map it into memory
...
int main() {
    ...
    pyre::memory::uri_t name {"constdirect-grid.dat"};
    ...
    pyre::memory::constdirect_t<cell_t> map {name, size};
