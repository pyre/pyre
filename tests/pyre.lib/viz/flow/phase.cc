...
// factories
using phase_t = pyre::viz::factories::selectors::phase_t;
using colormap_t = pyre::viz::factories::colormaps::hsb_t;
...
main(int argc, char * argv[])
{
    ...
    // open a file
    auto stream = std::ofstream("phase.bmp", std::ios::out | std::ios::binary);
    // if successful
    if (stream.is_open()) {
        // write the bytes
