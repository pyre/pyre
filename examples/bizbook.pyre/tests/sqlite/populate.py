...
def test():
    ...
    locations = (
        location.pyre_immutable(id="p00", address="1 First Avenue", city="Boston", state="MA"),
        location.pyre_immutable(id="p01", address="2 Second Avenue", city="Washington", state="DC"),
        location.pyre_immutable(id="p02", address="3 Third Avenue", city="Berkeley", state="CA"),
    ...
    items = (
        item.pyre_immutable(
            invoice="I01", book="PS2091", ordered=75, shipped=75, date="1985/09/15"
        ),
        item.pyre_immutable(
            invoice="I02", book="PS2091", ordered=10, shipped=10, date="1985/09/15"
        ),
        item.pyre_immutable(
            invoice="I03", book="PS2091", ordered=20, shipped=20, date="1985/09/18"
        ),
        item.pyre_immutable(
            invoice="I04", book="MC3021", ordered=25, shipped=20, date="1985/09/18"
        ),
        item.pyre_immutable(
            invoice="I05", book="MC3021", ordered=15, shipped=15, date="1985/09/14"
        ),
        ...
        item.pyre_immutable(
            invoice="I19", book="BU2075", ordered=35, shipped=35, date="1988/03/15"
        ),
        item.pyre_immutable(
            invoice="I10", book="BU7832", ordered=15, shipped=15, date="1987/10/29"
        ),
        item.pyre_immutable(
            invoice="I11", book="MC2222", ordered=10, shipped=10, date="1988/01/12"
        ),
        item.pyre_immutable(
            invoice="I12", book="PC1035", ordered=30, shipped=30, date="1987/03/24"
        ),
        item.pyre_immutable(
            invoice="I13", book="PC8888", ordered=50, shipped=50, date="1987/03/24"
        ),
        item.pyre_immutable(
            invoice="I14", book="PS1372", ordered=20, shipped=20, date="1987/03/29"
        ),
        item.pyre_immutable(
            invoice="I14", book="PS2106", ordered=25, shipped=25, date="1987/04/29"
        ),
        item.pyre_immutable(
            invoice="I14", book="PS3333", ordered=15, shipped=10, date="1987/05/29"
        ),
        item.pyre_immutable(
            invoice="I14", book="PS7777", ordered=25, shipped=25, date="1987/06/13"
        ),
        item.pyre_immutable(
            invoice="I15", book="TC3218", ordered=40, shipped=40, date="1987/06/15"
        ),
        item.pyre_immutable(
            invoice="I15", book="TC4203", ordered=20, shipped=20, date="1987/05/30"
        ),
        item.pyre_immutable(
            invoice="I15", book="TC7777", ordered=20, shipped=10, date="1987/06/17"
        ),
    )
    # add them to their table
    for item in items:
