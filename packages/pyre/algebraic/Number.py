...
class Number:
    ...
    def __add__(self, other):
        ...
        return self.operator(operator=operator.add, operands=(self, other))
    ...
    def __sub__(self, other):
        ...
        return self.operator(operator=operator.sub, operands=(self, other))
    ...
    def __mul__(self, other):
        ...
        return self.operator(operator=operator.mul, operands=(self, other))
    ...
    def __truediv__(self, other):
        ...
        return self.operator(operator=operator.truediv, operands=(self, other))
    ...
    def __floordiv__(self, other):
        ...
        return self.operator(operator=operator.floordiv, operands=(self, other))
    ...
    def __mod__(self, other):
        ...
        return self.operator(operator=operator.mod, operands=(self, other))
    ...
    def __pow__(self, other):
        ...
        return self.operator(operator=operator.pow, operands=(self, other))
    ...
    def __neg__(self):
        return self.operator(operator=operator.neg, operands=(self,))

    
    def __abs__(self):
        return self.operator(operator=operator.abs, operands=(self,))
    ...
    def __radd__(self, other):
        ...
        other = self.literal(value=other)
        # build an addition representation
        return self.operator(operator=operator.add, operands=(other,self))
    ...
    def __rsub__(self, other):
        ...
        other = self.literal(value=other)
        # build a subtraction representation
        return self.operator(operator=operator.sub, operands=(other,self))
    ...
    def __rmul__(self, other):
        ...
        return self.operator(operator=operator.mul, operands=(other,self))
    ...
    def __rtruediv__(self, other):
        ...
        other = self.literal(value=other)
        # build a representation of division
        return self.operator(operator=operator.truediv, operands=(other,self))
    ...
    def __rfloordiv__(self, other):
        ...
        other = self.literal(value=other)
        # build a representation of floor-division 
        return self.operator(operator=operator.floordiv, operands=(other,self))
    ...
    def __rmod__(self, other):
        ...
        other = self.literal(value=other)
        # build a modulus representation
        return self.operator(operator=operator.mod, operands=(other,self))
    ...
    def __rpow__(self, other):
        ...
        other = self.literal(value=other)
        # build a representation of exponentiation
        return self.operator(operator=operator.pow, operands=(other,self))
