...
class Inventory(object):
    ...
    and interfaces, imports this class as its _pyre_Inventory and establishes the embryonic
    case.

    Requirement further decorates these class records with attributes named after the canonical
    trait names of a component/interface, and whose values are the defaults as specified in the
    trait declaration.
    ...
    _pyre_categories = None # Requirement will attach my trait category index here 
