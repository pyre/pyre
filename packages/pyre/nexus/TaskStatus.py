...
class TaskStatus(enum.Enum):
    ...
    failed = 1
    # the process has determined that this task cannot be completed successfully; for example,
    # executing the task raised exceptions that indicated configuration or logic errors; this
    # task should be removed from the workplan and the user should be notified
    aborted = 2
