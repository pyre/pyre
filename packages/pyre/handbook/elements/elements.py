...
technetium = Element(43, "tc", "technetium", 98.0)
...
promethium = Element(61, "pm", "promethium", 145.0)
...
polonium = Element(84, "po", "polonium", 209.0)
astatine = Element(85, "at", "astatine", 210.0)
radon = Element(86, "rn", "radon", 222.0)
francium = Element(87, "fr", "francium", 223.0)
...
plutonium = Element(94, "pu", "plutonium", 244.0)
americium = Element(95, "am", "americium", 243.0)
curium = Element(96, "cm", "curium", 247.0)
berkelium = Element(97, "bk", "berkelium", 247.0)
californium = Element(98, "cf", "californium", 251.0)
einsteinium = Element(99, "ei", "einsteinium", 252.0)
fermium = Element(100, "fm", "fermium", 257.0)
mendelevium = Element(101, "md", "mendelevium", 258.0)
nobelium = Element(102, "no", "nobelium", 259.0)
lawrencium = Element(103, "lw", "lawrencium", 269.0)
