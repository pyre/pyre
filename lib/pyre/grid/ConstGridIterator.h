...
// code guard
#if !defined(pyre_grid_ConstGridIterator_h)
#define pyre_grid_ConstGridIterator_h


// declaration
template <typename gridT>
class pyre::grid::ConstGridIterator {
    // types
public:
    // my parts
    ...
    // meta-methods
public:
    inline ConstGridIterator(const grid_type & grid, const iterator_type & it);
