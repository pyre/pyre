...
pyre_test_driver_env(tests/journal.lib/chronicler_decor.cc JOURNAL_DECOR=3 3)
pyre_test_driver_env_case(tests/journal.lib/chronicler_decor.cc JOURNAL_DECOR=5 5)
...
pyre_test_driver(tests/journal.lib/debug_detail.cc)
pyre_test_driver(tests/journal.lib/debug_here.cc)
...
pyre_test_driver(tests/journal.lib/error_detail.cc)
pyre_test_driver(tests/journal.lib/error_here.cc)
...
pyre_test_driver(tests/journal.lib/firewall_detail.cc)
pyre_test_driver(tests/journal.lib/firewall_here.cc)
...
pyre_test_driver(tests/journal.lib/help_detail.cc)
pyre_test_driver(tests/journal.lib/help_here.cc)
...
pyre_test_driver(tests/journal.lib/help_sanity.cc)
...
pyre_test_driver(tests/journal.lib/info_detail.cc)
pyre_test_driver(tests/journal.lib/info_here.cc)
...
pyre_test_driver(tests/journal.lib/info_sanity.cc)
...
pyre_test_driver(tests/journal.lib/warning_detail.cc)
pyre_test_driver(tests/journal.lib/warning_here.cc)
