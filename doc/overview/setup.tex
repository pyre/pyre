...
\lstset{
  ...
  % 
  numbers=left,
  numberstyle=\color{pyre@stone}\tiny,
  stepnumber=1,
  numbersep=5pt,
  numberblanklines=true,
  % 
  basicstyle=\tt\bfseries\scriptsize,
  keywordstyle=\color{pyre@blue}\bfseries,
  commentstyle=\color{pyre@stone}\slshape,
  stringstyle=\color{pyre@olive}\slshape,
  showstringspaces=false,
  % 
  frame=,
  captionpos=t,
  backgroundcolor=\color{pyre@cream},
  xleftmargin=0em,
  xrightmargin=0em
} 
