...
%
  \item the implementation of \component{Ball} in \srcfile{gauss/shapes/Ball.py}
    \python{firstnumber=9,linerange={9-21}}{listings/gauss/shapes/Ball.py}
%
  \end{itemize}
%
\end{frame}
...
%
  \item the implementation of \method{Ball.measure}
    \python{firstnumber=23,linerange={23-42}}{listings/gauss/shapes/Ball.py}
%
  \end{itemize}
%
\end{frame}
...
%
  \begin{itemize}
%
  \item the implementation of \method{Ball.interior}
...
%
  \begin{itemize}
%
  \item the implementation of \method{Box.interior}
    \python{firstnumber=33,linerange={33-52}}{listings/gauss/shapes/Box.py}
%
  \end{itemize}
%
\end{frame}
