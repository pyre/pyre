...
In a similar vein, \lstref{generators:constant} shows the implementation of the functor
\class{Constant} that represents a constant function. Instantiating \class{Constant} with
\identifier{constant} set to unity will enable us to compute the $pi$ estimate and reproduce
