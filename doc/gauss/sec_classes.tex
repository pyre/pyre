...
\python{
  ...
  caption={\srcfile{classes/WichmannHill.py}: Encapsulating the standard python generator},
...
\python{
  ...
  caption={\srcfile{classes/Disk.py}: Representing our region of integration},
...
\python{
  ...
  caption={\srcfile{containers/WichmannHill.py}: Filling a container with random points},
