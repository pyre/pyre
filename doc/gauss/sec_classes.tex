...
all of their methods should generate exceptions. We will use \class{PointCloud} to derive
...
\class{PointCloud} and implement the standard interface using the new generator.
...
%
Since \class{PointCloud} is abstract, we can't provide a non-trivial implementation; instead
...
%
from which we will inherit in a class \class{Disk} that will represent the interior of a
