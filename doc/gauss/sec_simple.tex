...
the integrand is reflected in the number of calls to the random number generator per
iteration. Further, our sampling box $B$ has unit area, so there is no need for any extra
