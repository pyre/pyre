...
\algref{pi}. The python standard library \cite{python-doc} includes the package {\tt random}
with an implementation of the Mersenne Twister \cite{mersenne-twister} random number
